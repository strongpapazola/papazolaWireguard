...
PersistentKeepalive = 25" > $WEBDIR/$CLIENT_NAME.conf
qrencode -t ansiutf8 -l L < $WEBDIR/$CLIENT_NAME.conf
...
#    systemctl start wg-quick@wg0.service
    ...
    echo "Client config --> $WEBDIR/$CLIENT_NAME.conf"
...
qrencode -t ansiutf8 -l L < $WEBDIR/$CLIENT_NAME.conf
    ...
    echo "Client added, new configuration file --> $WEBDIR/$CLIENT_NAME.conf"
fi
